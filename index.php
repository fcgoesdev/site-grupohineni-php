...
<section id="servicos" class="py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Hineni Digital -->
            <div class="bg-gradient-to-br from-pink-50 to-orange-50 rounded-lg p-8 border-2 border-pink-200 hover:shadow-lg transition">
                <div class="gradient-pink-orange text-white rounded-lg p-4 w-12 h-12 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                    </svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Hineni Digital</h3>
                <p class="text-gray-700 mb-6">Soluções completas de marketing digital, desenvolvimento web e e-commerce para impulsionar seu negócio.</p>
                <ul class="space-y-2 text-sm text-gray-700 mb-6">
                    <li class="flex items-center"><span class="text-pink-500 mr-2">✓</span> Estratégia Digital</li>
                    <li class="flex items-center"><span class="text-pink-500 mr-2">✓</span> Desenvolvimento Web</li>
                    <li class="flex items-center"><span class="text-pink-500 mr-2">✓</span> E-Commerce</li>
                    <li class="flex items-center"><span class="text-pink-500 mr-2">✓</span> Marketing de Conteúdo</li>
                </ul>
                <a href="/hineni-digital.php" class="gradient-pink-orange text-white px-6 py-2 rounded-lg font-semibold hover:shadow-lg transition inline-block">
                    Saiba Mais
                </a>
            </div>

            <!-- Hineni Cybersecurity -->
            <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-8 border-2 border-purple-200 hover:shadow-lg transition">
                <div class="gradient-blue-purple text-white rounded-lg p-4 w-12 h-12 flex items-center justify-center mb-4">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                    </svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Hineni Cybersecurity</h3>
                <p class="text-gray-700 mb-6">Proteção completa contra ameaças cibernéticas com testes de penetração, análise de vulnerabilidades e consultoria em segurança.</p>
                <ul class="space-y-2 text-sm text-gray-700 mb-6">
                    <li class="flex items-center"><span class="text-purple-500 mr-2">✓</span> Testes de Penetração</li>
                    <li class="flex items-center"><span class="text-purple-500 mr-2">✓</span> Análise de Vulnerabilidades</li>
                    <li class="flex items-center"><span class="text-purple-500 mr-2">✓</span> Segurança de APIs</li>
                    <li class="flex items-center"><span class="text-purple-500 mr-2">✓</span> Consultoria em Segurança</li>
                </ul>
                <a href="/hineni-cybersecurity.php" class="gradient-blue-purple text-white px-6 py-2 rounded-lg font-semibold hover:shadow-lg transition inline-block">
                    Saiba Mais
                </a>
            </div>
        </div>
